...
import 's_b_default_model.dart';
export 's_b_default_model.dart';

class SBDefaultWidget extends StatefulWidget {
  const SBDefaultWidget({
    super.key,
    String? text,
    String? btnText,
...
class _SBDefaultWidgetState extends State<SBDefaultWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SBDefaultModel());
  }
