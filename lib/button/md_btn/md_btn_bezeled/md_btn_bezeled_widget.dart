...
import 'md_btn_bezeled_model.dart';
export 'md_btn_bezeled_model.dart';

class MdBtnBezeledWidget extends StatefulWidget {
...
class _MdBtnBezeledWidgetState extends State<MdBtnBezeledWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MdBtnBezeledModel());
  }
