...
import 'lg_btn_disabled_model.dart';
export 'lg_btn_disabled_model.dart';

class LgBtnDisabledWidget extends StatefulWidget {
...
class _LgBtnDisabledWidgetState extends State<LgBtnDisabledWidget> {
  late LgBtnDisabledModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LgBtnDisabledModel());
  }
